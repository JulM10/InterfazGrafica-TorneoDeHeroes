...
public class BatallaControlador {
    ...
    private void ejecutarTurno() {
        ...
        String encabezado = "---- Turno " + turnoActual + " ----";
        vista.logEvento("\n── Turno " + turnoActual + " ──");
        batalla.getLogTurnos().add(encabezado);

        // Heroe ataca
        int danioHeroe = heroe.atacar();
        villano.recibirDanio(danioHeroe);
        String eventoHeroe = heroe.getNombre() + " ataca: " + danioHeroe
                + " de daño → vida de " + villano.getNombre() + ": " + villano.getVida();
        vista.logEvento("⚔ " + eventoHeroe);
        batalla.getLogTurnos().add(eventoHeroe);
        ...
        String eventoVillano = villano.getNombre() + " ataca: " + danioVillano
                + " de daño → vida de " + heroe.getNombre() + ": " + heroe.getVida();
        vista.logEvento("💀 " + eventoVillano);
        batalla.getLogTurnos().add(eventoVillano);
    ...
    private void rendirse() {
        String evento = heroe.getNombre() + " se rindio.";
        vista.logEvento("\n⚑ " + evento);
        batalla.getLogTurnos().add(evento);
        finalizarBatalla(villano);
    }
    ...
    private void finalizarBatalla(Personaje ganador) {
        ...
        try {
            ...
            batalla.getLogTurnos().add("GANADOR: " + ganador.getNombre());
