...
public class VentanaConfig extends JFrame {
    ...
    public void agregarFilaTabla(String nombre, String apodo, String tipo,
            int vida, int fuerza, int defensa, int victorias) {
        modeloTabla.addRow(new Object[] { nombre, apodo, tipo, vida, fuerza, defensa, victorias });
    }
